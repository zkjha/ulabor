/**
 前端部署（包括了对代码的混淆，压缩，和对模板文件的修改，版本号的计算，以及后续CDN的推送等等） 主文件，
 * 负责执行流程的控制。
 */
...
var version = config.version || gitRevision || Math.round(new Date().getTime() / 1000), logfile = './log/deploy.' + version + '.log';
