...
router.post("/joinList",function(req, res, next){
    ...
    console.log(options);
    request.post(remoteUrl.applicationList,options, function (error, response, body) {
...
router.post("/agree",function(req, res, next){
    ...
    console.log(options);
    request.post(remoteUrl.review,options, function (error, response, body) {
...
//审批借用同意或拒绝
router.post("/loanAgree",function(req, res, next){
    var session=req.session;
    ...
    console.log(options);
    request.post(remoteUrl.loanAgree,options, function (error, response, body) {
